...
const styles = StyleSheet.create({
  container: { flex: 1, padding: spacing.lg, maxWidth: contentMaxWidth, alignSelf: 'center', width: '100%' },
  title: { ...typography.title, color: colors.primaryPinkDark, marginBottom: spacing.md },
  tabs: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.lg },
  label: { color: colors.textMuted, marginBottom: spacing.sm },
  code: { fontSize: 36, fontWeight: '700', letterSpacing: 8, textAlign: 'center', color: colors.primaryBlueDark, marginBottom: spacing.lg },
